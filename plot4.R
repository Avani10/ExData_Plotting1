raw_data <- "data/household_power_consumption.txt"
...
globalReactivePower <- as.numeric(data_2$Global_reactive_power)
voltage <- as.numeric(data_2$Voltage)
subMetering1 <- as.numeric(data_2$Sub_metering_1)
subMetering2 <- as.numeric(data_2$Sub_metering_2)
subMetering3 <- as.numeric(data_2$Sub_metering_3)
